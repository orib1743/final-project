...
def find_best_match(title, candidates, threshold=80):
    """ מחפש את ההתאמה הטובה ביותר בעזרת fuzzywuzzy ובמידת הצורך LaBSE """
    best_match = None
    best_score = 0
    best_bert_score = 0
    ...
    for candidate in candidates:
        ...
        if fw_score > best_score:
            ...
            # אם fuzzywuzzy מצא התאמה מעל סף מסוים, נחשב גם דמיון באמצעות LaBSE
...
matched_df.to_excel(r"C:\Users\yifat\PycharmProjects\Final-Project\Output_Files\LaBSE_Matched_Titles.xlsx", index=False)
...
df_unique_2017.to_excel(r"C:\Users\yifat\PycharmProjects\Final-Project\Output_Files\LaBSE_Unique_Titles_2017_Fuzzy.xlsx", index=False)
df_unique_2018.to_excel(r"C:\Users\yifat\PycharmProjects\Final-Project\Output_Files\LaBSE_Unique_Titles_2018_Fuzzy.xlsx", index=False)
df_common.to_excel(r"C:\Users\yifat\PycharmProjects\Final-Project\Output_Files\LaBSE_Common_Titles_Fuzzy.xlsx", index=False)
...
def compute_similarity(chunks_2017, chunks_2018, threshold=0.6):
    # בדיקה אם אחת הרשימות ריקה כדי למנוע שגיאות
...
df_similarity.to_excel(r"C:\Users\yifat\PycharmProjects\Final-Project\Output_Files\LaBSE_Similarity_Results_Fuzzy.xlsx", index=False)
