    ...
    for page_num, page_content in content_with_pages:
        ...
        for level, pattern in patterns.items():
            ...
            for match in matches:
                ...
                # Extract content up to 1000 characters or until the next pattern
                next_content = processed_content[end_pos:]
                content = []
                ...
                hierarchy_data.append({
                    ...
                    "title_type": level,
                    "content": content.strip(),  # Extract content following the title
...
output_file = "D:\\yifat\\Extract_Data_Project\\Extracted_Hierarchy_Data_With_Paragraph_2017.xlsx"
